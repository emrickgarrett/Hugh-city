          ...
          {view === "credits" && (
            <>
              ...
              >
                ...
                <div><strong>Art:</strong> <a href="https://x.com/ghosttyped" target="_blank" rel="noopener noreferrer" style={{ color: "var(--rct-text)", textDecoration: "underline" }}>@ghosttyped</a></div>
